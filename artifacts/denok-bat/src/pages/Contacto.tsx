...
export default function Contacto() {
  ...
  const contactItems = [
    { icon: MapPin, labelKey: "contact.address_label", value: "Calle Mayor, 12 — Bilbao, Bizkaia" },
    { icon: Phone, labelKey: "contact.phone_label", value: "+34 944 000 000" },
    { icon: Mail, labelKey: "contact.email_label", value: "info@denokbat.eus" },
    { icon: Clock, labelKey: "contact.hours_label", value: "Lun–Vie / Ast–Bar: 9:00–14:00 | 16:00–19:00" },
  ];
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-3xl border border-border p-8 shadow-sm">
            <h2 className="text-2xl font-bold mb-6">{t("form.send_message_title")}</h2>
            {enviado ? (
