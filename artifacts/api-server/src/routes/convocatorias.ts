    ...
    if (propIds.length > 0) {
      ...
      for (const row of propRows.rows as Record<string, unknown>[]) {
        const r: PropuestaRow = {
          ...
          antecedentes: (row.antecedentes as string | null) ?? null,
          antecedentesUrl: (row.antecedentes_url as string | null) ?? null,
          antecedentesFilename: (row.antecedentes_filename as string | null) ?? null,
          antecedentesSize: (row.antecedentes_size as number | null) ?? null,
          antecedentesSubidoEn: (row.antecedentes_subido_en as Date | null) ?? null,
          antecedentesSubidoPor: (row.antecedentes_subido_por as number | null) ?? null,
